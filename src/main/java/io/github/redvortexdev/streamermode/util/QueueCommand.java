                    ...
                    try {
                        ...
                        WebUtility.getString("https://twitch.center/customapi/quote/list?token=18a3878c").thenAccept(content -> {
                            ...
                            for (String entry : splitQueue) {
                                ...
                                String idString = Objects.requireNonNullElse(plotId, "?");
                            ...
                            for (QueueEntry entry : queue) {
                                ...
                                if (!entry.getStrippedDescription().isEmpty()) {
                                    description = Component.text(entry.getStrippedDescription(), Palette.SKY_LIGHT);
                                }
