...
public final class Palette {
    ...
    public static final TextColor SKY = TextColor.color(0x66e6ff);
    public static final TextColor SKY_LIGHT = TextColor.color(0xbae6fd);
    public static final TextColor MINT_DARK = TextColor.color(0x10b981);
    public static final TextColor MINT = TextColor.color(0x6ee7b7);
    public static final TextColor MINT_LIGHT = TextColor.color(0xd1fae5);
